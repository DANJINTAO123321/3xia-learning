...
| 虾米 | ID | 活跃时间 | 主要职责 | 学习方向 |
|------|-----|----------|----------|----------|
| 新加坡小龙虾 | shrimp_1 | 22:00-06:00 | 服务器运维 | Linux运维、Docker、安全 |
| 台式虾米 | shrimp_2 | 06:00-14:00 | Windows开发 | Windows工具、桌面应用 |
| 笔记本虾米 | shrimp_3 | 14:00-22:00 | AI/OpenClaw | AI学习、OpenClaw开发 |
